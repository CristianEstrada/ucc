  ...
  export default {
    ...
    mounted() {
      if (this.familiar.editar) {
        ...
        this.Family_nucleus = this.familiar.Family_nucleus;
        this.treatment_start_date = this.familiar.treatment_start_date;
        this.clinic_history = this.familiar.clinic_history;
        this.admission_date = this.familiar.admission_date;
        ...
        this.funeral_insurance = this.familiar.funeral_insurance;
